...
public class BonusStatic extends BaseService {
	...
	private void dayPointsStatic() throws InterruptedException {
		...
		openPrompt("sentOutPointsDetail");// 打开发放积分详情
		search("userName4DayDetailSearch", "mobile4DayDetailSearch", SeleniumConstants.user, SeleniumConstants.phone,
				"searchSubmit4DayDetailSearch", "dayDetailPages");
		closePrompt("dayDetailPanel", 1);// 关闭弹框
		openPrompt("receivedPointsDetail");// 打开回收积分详情
		searchTest("searchSubmit4DayDetailSearch", "dayDetailPages");
		closePrompt("dayDetailPanel", 1);// 关闭弹框
	...
	private void perPointsRank() throws InterruptedException {
		...
		int total = 0;
		String user1 = dr.findElement(By.xpath("//*[@id='staticList']/table/tbody/tr[1]/td[2]")).getText();
		String phone1 = dr.findElement(By.xpath("//*[@id='staticList']/table/tbody/tr[1]/td[3]")).getText();
		String totalpoints = dr.findElement(By.xpath("//*[@id='staticList']/table/tbody/tr[1]/td[4]/a")).getText();

		search("userName4RankSearch", "mobile4RankSearch", user1, phone1, "searchBtn4Rank", "pages");
		...
		List<WebElement> elements = dr.findElements(By.xpath("//*[@id='rankDetailList']/table/tbody/tr/td[7]"));
	...
	protected void openPrompt(String name) throws InterruptedException {
